...
<form id="insRaceInfo" name="insRaceInfo" ng-submit="insRaceInfo.$valid && chInCont.SubmitRaceInfo()" novalidate>
	<div ng-show="chInCont.char.race_build.race.race_id">
		<p class="underline_center">
			...
			<span><input type="text" name="charAge" id="charAge" ng-model="chInCont.char.race_build.age" maxlength="3" size="3" pattern="^[0-9]+$" required/></span>
		</p>
		<p class="underline_center">
		...
		<p class="underline_center">
			...
			<span><input type="text" name="charWeight" id="charWeight" ng-model="chInCont.char.race_build.weight" maxlength="3" size="3" pattern="^[0-9]+$" required/></span>
		</p>
	</div>
