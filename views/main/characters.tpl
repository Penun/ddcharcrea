<div ng-show="mainCont.ShowCharDetails()" class="right_page_in">
	...
	<div><b>Str</b>: {{"{{chara.b_str}}"}}<span class="reset" ng-show="chara.bo_str > 0"> + {{"{{chara.bo_str}}"}} :: {{"{{chara.t_str}}"}}</span></div>
	<div><b>Dex</b>: {{"{{chara.b_dex}}"}}<span class="reset" ng-show="chara.bo_dex > 0"> + {{"{{chara.bo_dex}}"}} :: {{"{{chara.t_dex}}"}}</span></div>
	<div><b>Con</b>: {{"{{chara.b_con}}"}}<span class="reset" ng-show="chara.bo_con > 0"> + {{"{{chara.bo_con}}"}} :: {{"{{chara.t_con}}"}}</span></div>
	<div><b>Int</b>: {{"{{chara.b_int}}"}}<span class="reset" ng-show="chara.bo_int > 0"> + {{"{{chara.bo_int}}"}} :: {{"{{chara.t_int}}"}}</span></div>
	<div><b>Wis</b>: {{"{{chara.b_wis}}"}}<span class="reset" ng-show="chara.bo_wis > 0"> + {{"{{chara.bo_wis}}"}} :: {{"{{chara.t_wis}}"}}</span></div>
	<div><b>Cha</b>: {{"{{chara.b_cha}}"}}<span class="reset" ng-show="chara.bo_cha > 0"> + {{"{{chara.bo_cha}}"}} :: {{"{{chara.t_cha}}"}}</span></div>
